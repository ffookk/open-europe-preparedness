...
<div id="change-controls"><label for="change-filter">Snapshot change</label><select id="change-filter"><option value="">All changes</option></select></div><div><label for="jurisdiction">Jurisdiction</label><select id="jurisdiction"><option value="">All</option></select></div><div><label for="record-type">Record type</label><select id="record-type"><option value="">All</option></select></div><div><label for="status-filter">Record review status</label><select id="status-filter"><option value="">All</option></select></div><div><label for="reason-filter">Structural triage reason</label><select id="reason-filter"><option value="">All reasons</option></select></div><div id="transition-controls"><label for="transition-filter">Independent field transitions</label><select id="transition-filter"><option value="">All</option><option value="source_evidence_changed">Source evidence changed</option><option value="policy_dates_changed">Policy dates changed</option><option value="policy_stage_changed">Policy stage changed</option><option value="verification_status_changed">Review status changed</option></select></div></div></div>
